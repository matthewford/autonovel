...
def call_writer(prompt, max_tokens=16000):
    return generate(
        ...
        system=(
            ...
            "Follow the POV and tense established in the book profile, voice profile, "
            "and outline. "
...
def main():
    ...
    target_words = profile.chapter_target_words
...
1. Write the COMPLETE chapter. Target ~{target_words:,} words. Do not truncate or summarize.
2. Follow the POV, tense, and focal character established in the voice profile and outline.
3. Hit ALL numbered beats from the outline in order.
4. Plant ALL foreshadowing elements listed under "Plants."
5. Show concrete sensory detail anchored in this protagonist's body and world.
6. Any magic, stress, or injury should have specific physical consequences, not vague discomfort.
...
11. Metaphors from the protagonist's specific experience and world.
